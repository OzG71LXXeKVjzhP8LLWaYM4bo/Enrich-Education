        ...
        <section className="mb-16">
          <Card className="bg-white/10 backdrop-blur-md border-white/20">
            ...
            <CardContent className="text-white/90">
              ...
              <p className="mb-4">
                We expect all our students to complete their homework diligently and on time. This is not just about academic performance; it is about instilling discipline, responsibility, and a strong work ethic that will serve them well beyond their academic years.
              </p>
              <p>
                Our teachers provide detailed feedback on homework, ensuring that students understand their mistakes and learn from them. We also involve parents in this process, keeping them informed about their childs progress and any areas that need additional attention.
              </p>
            </CardContent>
          </Card>
        </section>
